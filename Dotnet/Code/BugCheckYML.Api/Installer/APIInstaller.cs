...
using BugCheckYML.Api.Filters;
using BugCheckYML.BusinessServices.Installer;

namespace BugCheckYML.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "BugCheckYML API", Version = version + "-" + branch});
            });
